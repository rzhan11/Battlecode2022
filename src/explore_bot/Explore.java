...
public class Explore {
    ...
    public static int momentumLock; // locks momentum for x number of turns

    final public static int MOMENTUM_LOCK_ROUNDS = 3; // locks momentum for x number of turns
    ...
    final public static int WALL_REPULSE_DIST = 3;
    final public static double WALL_FORCE_CONSTANT = 10.0;
...
//        }
    ...
    public static void updateMomentumEnemy() {
        ...
        double allySupportFactor = Math.min(1 + allyAttackCount, 5);
