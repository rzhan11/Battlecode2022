...
import static pathing_bot.Bug.*;
import static pathing_bot.Constants.*;
...
//        ttlog(checkDirMoveable(dir) + " " + !wanderCenter.isWithinDistanceSquared(loc, centerRadius));
     ...
     */
    public static Direction wander(MapLocation centerLoc, int centerRadius, int cornerRadius, boolean goInner) throws GameActionException {
